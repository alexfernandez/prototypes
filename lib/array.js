 ...
 */
newArray.intersectWith = function (array) {
...
function testIntersection(callback) {
	...
	testing.assertEquals(arrayA.intersectWith(arrayB), [3], 'Invalid intersection', callback);
	testing.assertEquals(arrayB.intersectWith(arrayC), [4,5], 'Invalid intersection', callback);
	testing.assertEquals(arrayA.intersectWith(arrayC), [], 'Invalid intersection', callback);
	testing.assertEquals(arrayA.intersectWith(empty), [], 'Invalid intersection', callback);
	testing.success(callback);
}
